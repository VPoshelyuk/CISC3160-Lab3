...
{
       0,     0,     3,     9,    15,    18,    19,    21,    25,    27
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    10,     4,     7,    11,     8,    -1,    10,
       5,     7,    12,     8,    -1,    10,     6,    -1,    -1,     3,
      -1,    11,     7,    11,    -1,     3,    -1,    12,     3,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    13,    13,    17,    21,    27,    29,    38,    43,    48
};
#endif
...
{
  "$end", "error", "$undefined", "DIGIT", "LETTER", "OTHER_ACTIVITY",
  "TOTAL", "' '", "'\\n'", "$accept", "list", "expr", "number", 0
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    32,    10
};
# endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 14 "grade_calc.y"
    {   
            if(save_single_activity_result((yyvsp[(2) - (5)]), (yyvsp[(4) - (5)])) == 0)return 0;
        }
    break;

  case 3:
#line 18 "grade_calc.y"
    {
            if(save_single_activity_result((yyvsp[(2) - (5)]), (yyvsp[(4) - (5)])) == 0)return 0;
        }
    break;
